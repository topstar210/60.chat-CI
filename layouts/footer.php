            ...
            <div class="ftr-inner">
                <section class="ftr-section ftr-mobile">
                    ...
                    <div class="ftr-content">
                        ...
                        </a><a id="btn-ftr-iphone-link" class="ftr-btn ftr-mobile-link" target="_blank" href="https://play.google.com/store/apps/details?id=com.guiang.chatapp&amp;hl=en">Download on the Google Play</a>
                    </div>
                </section>
            ...
            <div class="ftr-nav">
                <div class="ftr-inner">
                    <ul class="ftr-nav-list nav-primary">
                        ...
                        <li class="ftr-nav-list-item"><a class="ftr-nav-list-link" href="/terms-service">Terms</a></li>
                    ...
                    <ul class="ftr-nav-list nav-secondary">
                        <li class="ftr-nav-list-item">© <span id="footer-copyright-year">2022</span> ChatApp Inc</li>
                    </ul>
                </div>
            </div>
        </footer>
