...
<link rel="stylesheet" href="<?php echo base_url('assets'); ?>/css/meet.css">
        ...
        <div class="col-md-5 ">
            ...
            <div class="row" style="margin-top: 50px;">
                <div class="col-xs-4 col-md-3">
                    <div class="avatar" style="background-image:url('<?php echo base_url('assets'); ?>/imgs/unknown_2.png')"></div>
                    <!-- <div class="avatar" style="background-image:url('<?php echo base_url('assets'); ?>/imgs/<?php //echo strtolower($minfo->gender)."_1.png"; ?>')"></div> -->
                </div>
            ...
            <div id="partnerLoading" style="display: none">
                <img src="<?php echo base_url('assets'); ?>/imgs/processing.gif" style="max-width: 100%; height: 100%;"/>
            </div>
        </div>
        <div class="col-md-7">
            <div class="row">
                ...
                <div class="col-lg-12">
					...
					<div class="text-center" style="margin-top:10px"><a class="btn btn-lg btn-danger" style="padding:8px 40px;" href="/">Exit</a></div>
                </div>
            </div>
...
<script src="<?php echo base_url('assets'); ?>/vendor/RTCMultiConnection.js"></script>
<script src="<?php echo base_url('assets'); ?>/vendor/socket.io.js"></script>
<script src="<?php echo base_url('assets'); ?>/js/meet.js"></script>
