        ...
        <div class="container">
                ...
                <form id="frmFacetime" onsubmit="return checkForm();" action="sixtychat/faceWaiting" method="get" style="margin: 15px;">
                    <div class="row">
                        ...
                        <div class="form-group">
							...
							<div class="form-group">
                            <label><input type="checkbox" value="1" id="igree"> I understand the <a target="blank" href="sixtychat/term">terms of 60</a>.</label>                            
                        </div>
                            <div class="form-group" style="margin-top: 15px;">
            ...
            <div class="col-md-7">
                <div class="text-center"> 
                    ...
                    <img style="max-width: 100%; visibility: visible;" src="<?php echo base_url('assets'); ?>/imgs/60s_img.png" data-xblocker="passed">
                </div>
            </div>
