...
<div class="container" style="position: relative;">
    <div class="row" style="margin-top: 70px;margin-bottom: 70px">
        <div class="col-md-5 ">
			...
			<div style="margin-top: 35px; color:red">Note: Please Allow your Device to Access the Camera and Microphone</div>
        </div>
        <div class="col-md-7">
            <img src="<?php echo base_url('assets'); ?>/imgs/call.gif" style="max-width: 100%;"/>
        </div>
